...
public abstract class WorldGenChimewoodTree extends WorldGenAbstractTree {
	private static final IBlockState LOG = ModBlocks.chimewoodlog.getDefaultState();
    private static final IBlockState LEAF = ((Block)ModBlocks.chimewoodlog).getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenChimewoodTree(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
