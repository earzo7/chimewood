...
public class Reference {
    ...
    public static enum ChimewoodEnchants {
//      unlocalized       registry
		CHOPPER("enchantmentaxe", "EnchantmentAxe");
		
		private String unlocalizedName;
		private String registryName;

		ChimewoodEnchants(String unlocalizedName, String registryName) {
	...
	public static enum ChimewoodBlocks {
		...
		CHIMEWOODLEAVES("chimewoodleaves", "ChimewoodLeaves"),
		CHIMEWOODSAPLING("chimewoodsapling", "ChimewoodSapling"),
		VOID("voidblock", "VoidBlock"),
		THUNDERSTONE("thunderstone", "ThunderstoneBricks"),
		KEYTILE("keytile", "KeyTile");
